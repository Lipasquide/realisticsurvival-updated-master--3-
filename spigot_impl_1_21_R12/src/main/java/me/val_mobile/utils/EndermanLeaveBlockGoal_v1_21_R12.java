...
public class EndermanLeaveBlockGoal_v1_21_R12 extends Goal {
    private final EnderMan enderman;

    public EndermanLeaveBlockGoal_v1_21_R12(EnderMan enderman) {
        this.enderman = enderman;
    }

    public boolean canUse() {
            return this.enderman.getCarriedBlock() != null 
            && (Boolean) getServerLevel(this.enderman).getGameRules().get(GameRules.MOB_GRIEFING)
